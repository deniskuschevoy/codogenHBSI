...
include "HbsiValidator.php";
include "/../../Generation/HBSIEntityM.php";

class HbsiConfiguration extends Configuration
{

   public function __construct( $data )
   {
      parent::__construct($data, new HbsiValidator());
      $this->SetEntities(
   ...
   private function transformEntitiesArrayToModel( $entities )
   {
   	...
   	foreach ( $entities as $key => &$entity )
   	{
   		...
   		$entity = HBSIEntityM::create( $entity );
   	}
